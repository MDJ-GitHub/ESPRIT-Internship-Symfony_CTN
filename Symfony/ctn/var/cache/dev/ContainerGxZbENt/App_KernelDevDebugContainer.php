...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Event\\RoutingEventListener' => 'getRoutingEventListenerService',
        ...
        $this->fileMap = [
            'App\\Controller\\CommandantController' => 'getCommandantControllerService',
            'App\\Controller\\GestionnaireController' => 'getGestionnaireControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\MainController' => 'getMainControllerService',
            'App\\Controller\\NavigantController' => 'getNavigantControllerService',
            'App\\Controller\\UtilisageurController' => 'getUtilisageurControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Event'.\DIRECTORY_SEPARATOR.'RoutingEventListener.php';
    ...
    /**
     * Gets the public 'App\Event\RoutingEventListener' shared autowired service.
     *
     * @return \App\Event\RoutingEventListener
     */
    protected static function getRoutingEventListenerService($container)
    {
        $container->services['App\\Event\\RoutingEventListener'] = $instance = new \App\Event\RoutingEventListener(($container->services['router'] ?? self::getRouterService($container)));

        $instance->setContainer(($container->privates['.service_locator.O2p6Lk7'] ?? self::get_ServiceLocator_O2p6Lk7Service($container))->withContext('App\\Event\\RoutingEventListener', $container));
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\Event\\RoutingEventListener')] fn () => ($container->services['App\\Event\\RoutingEventListener'] ?? self::getRoutingEventListenerService($container)), 'onKernelRequest'], 0);
